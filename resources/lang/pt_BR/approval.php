...
return [
    ...
    'actions' => [
        ...
        'ambiguous_approval_operation' => 'Esta alteração corresponde a mais de uma ação de aprovação. Nenhuma alteração foi salva.',
    ...
    'infolist' => [
        ...
        'change_line' => ':field: :current -> :requested',
        'changed' => 'Alterado',
        'redacted' => 'Oculto',
        'boolean_true' => 'Sim',
        'boolean_false' => 'Não',
